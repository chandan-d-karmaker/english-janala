        ...
        wordCard.innerHTML =
            ...
            <div class="text-center bg-base-100 rounded-xl p-10">
                ...
                <div class="flex justify-between mt-14">
                    ...
                    <div onclick="pronounceWord('${word.word}')" class="btn bg-[#1A91FF1A] hover:bg-[#1a90ff85]">
...
document.getElementById('btn-search').addEventListener('click', () => {
    ...
    const ip = document.getElementById('input-word');
    const searchValue = ip.value.trim().toLowerCase();
